  ...
  <td>
   ...
   <td>
    <a href="./designing-content/email-designer/email-designer-overview.md">
      <img alt="Concepteur d’email (vidéos)" src="./assets/email_designer_tutorial.png" />
    </a>
    <div>
      <a href="./designing-content/email-designer/email-designer-overview.md">
    <strong>Concepteur d’email (vidéos)</strong>
    </a>
    </div>
    <p>
    <em>Le concepteur d’email permet la création visuelle rapide et simple d’emails personnalisés.</em>
    <p>
  </td>
  <td>
